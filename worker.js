                ...
                try {
                    await chrome.scripting.executeScript({
                        ...
                        func: function(msg, version) {
                            ...
                            gradientContainer.id = 'neoexamshield-update-notification';
                            ...
                            // Header container with NeoExamShield title and close button
                            ...
                            const existingToast = document.getElementById('neoexamshield-update-notification') || document.getElementById('neopass-update-notification');
                            if (existingToast) {
